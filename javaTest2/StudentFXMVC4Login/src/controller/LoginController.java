...
public class LoginController implements Initializable {
	...
	public void handlerButtonLoginAction(ActionEvent event) {
		//1.아이디와 패스워드가 입력이 안되었을때 경고창을 준다.
		if(txtId.getText().equals("")||txtPassword.getText().equals("")) {
			alertDisplay(1,"로그인 실패","정신차려 아이디,패스워드 미입력","다시 제대로 입력하세요");
			
//			Alert alert= new Alert(AlertType.CONFIRMATION);  //경고창을 주는것,CONFIRMATION은 확증 뭐뭐 하겠습니까? , 인포메이션은 정보
//			alert.setTitle("로그인 실패");
//			alert.setHeaderText("정신차려 아이디,패스워드 미입력");
//			alert.setContentText("아이디와 비밀번호중에 미입력하는 항목있어요 \n"+"다시 제대로 입력하세요");
...
//			alert.showAndWait(); //보여주는것
			...
			alertDisplay(1,"로그인 실패","정신차려 아이디,패스워드 불일치","다시 제대로 입력하세요");
//			Alert alert= new Alert(AlertType.WARNING);  //경고창을 주는것,CONFIRMATION은 확증 뭐뭐 하겠습니까? , 인포메이션은 정보
//			alert.setTitle("로그인 실패");
//			alert.setHeaderText("정신차려 아이디,패스워드 불일치");
//			alert.setContentText("아이디와 비밀번호가 불일치합니다. \n"+"다시 제대로 입력하세요");
//			alert.setResizable(false);
//			alert.showAndWait(); //보여주는것
		}
